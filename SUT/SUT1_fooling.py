...
@dataclass
class FoolingConfig:
    model_path: str = r"C:\Users\akhiat\Desktop\Hackathon\ASAB\artifacts\sut1_mnist_classifier.keras"
    decoded_root_dir: str = r"../CVAutoEncoder/runs/cvae_mnist/cluster_sampling/decoded_cluster_samples"

    epsilon: float = 0.10
    m_samples_per_cluster: int = 1000

    output_dir: str = r"../CVAutoEncoder/runs/cvae_mnist/cluster_sampling/fooling_results"
...
def main() -> None:
    config = FoolingConfig(
        model_path=r"C:\Users\akhiat\Desktop\Hackathon\ASAB\artifacts\sut1_mnist_classifier.keras",
        decoded_root_dir=r"../CVAutoEncoder/runs/cvae_mnist/cluster_sampling_by_label/decoded_cluster_samples",
        epsilon=0.9,
        m_samples_per_cluster=1000,
        output_dir=r"../CVAutoEncoder/runs/cvae_mnist/cluster_sampling/fooling_results",
        expected_height=28,
        expected_width=28,
        expected_channels=1,
